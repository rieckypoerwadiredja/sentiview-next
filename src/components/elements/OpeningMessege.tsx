...
export function YoutubeOpening() {
  return (
    <>
      <h1 className="text-2xl font-semibold mb-4">
        <span className="text-[#3a30ba]">💬 Sentiview AI Chat</span> – YouTube
        Comment Insight
      </h1>

      <p className="mb-4 text-gray-700">
        This chat room helps you analyze public sentiment from YouTube video
        comments. Just paste a link to any video and get a breakdown of what
        viewers really think—perfect for content creators, marketers, and
        researchers.
      </p>

      <p className="text-[#3a30ba] font-semibold">🎯 Features:</p>
      ...
      <div className="space-y-4 mb-8">
        <div className="flex items-start gap-2">
          ...
          <div>
            <span className="text-[#3a30ba] font-medium">
              Understand Viewer Sentiment :{" "}
            </span>
            <span className="text-gray-700">
              Instant analysis of thousands of comments to gauge how your
              audience feels about the content.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              Identify frequently mentioned phrases and recurring topics over
              time.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <span className="text-[#3a30ba] font-medium">
              Detect Community Feedback Issues :{" "}
            </span>
            <span className="text-gray-700">
              Quickly find critiques or controversial elements that need
              addressing.
            </span>
          </div>
        </div>
...
export function TwitterOpening() {
  return (
    <>
      <h1 className="text-2xl font-semibold mb-4">
        <span className="text-[#3a30ba]">💬 Sentiview AI Chat</span> – Twitter
        Campaign Analyzer
      </h1>

      <p className="mb-4 text-gray-700">
        Enter your Twitter campaign hashtag or tweet URL. Sentiview will analyze
        public replies and mentions to uncover real-time sentiment, audience
        reactions, and trending topics.
      </p>

      <p className="text-[#3a30ba] font-semibold">📊 What You Can Expect:</p>
      ...
      <div className="space-y-4 mb-8">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              How people react emotionally to your tweet or hashtag campaign.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              Track words people associate with your brand or campaign.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              Spot spikes in mentions or reactions to optimize timing and
              messaging.
            </span>
          </div>
        </div>
...
export function ShopeeOpening() {
  return (
    <>
      <h1 className="text-2xl font-semibold mb-4">
        <span className="text-[#3a30ba]">💬 Sentiview AI Chat</span> – Shopee
        Product Review Assistant
      </h1>

      <p className="mb-4 text-gray-700">
        Paste a Shopee product link, and this AI tool will extract all customer
        reviews, process them, and summarize the most valuable insights into
        your product quality, complaints, and standout features.
      </p>

      <p className="text-[#3a30ba] font-semibold">📦 Key Insights Include:</p>
      ...
      <div className="space-y-4 mb-8">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              What customers love and dislike most in one glance.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <span className="text-[#3a30ba] font-medium">
              Usage Experience Trends :{" "}
            </span>
            <span className="text-gray-700">
              “Fast delivery,” “bad packaging,” “authentic product” and more
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              Recommendations based on patterns found across hundreds of
              reviews.
            </span>
          </div>
        </div>
...
export function TokopediaOpening() {
  return (
    <>
      <h1 className="text-2xl font-semibold mb-4">
        <span className="text-[#3a30ba]">💬 Sentiview AI Chat</span> – Tokopedia
        Insight Engine
      </h1>

      <p className="mb-4 text-gray-700">
        Tokopedia users leave thousands of valuable product reviews. This
        assistant helps you analyze them all automatically—giving you product
        development signals, recurring pain points, and customer praise.
      </p>

      <p className="text-[#3a30ba] font-semibold">🔎 Extracted Insights:</p>
      ...
      <div className="space-y-4 mb-8">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <span className="text-gray-700">
              Clear breakdown of good vs bad customer feedback.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <span className="text-[#3a30ba] font-medium">
              Find Patterns Across SKUs :{" "}
            </span>
            <span className="text-gray-700">
              Compare reviews across multiple variations or listings.
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <span className="text-[#3a30ba] font-medium">
              Drive Marketing Ideas :{" "}
            </span>
            <span className="text-gray-700">
              Use keyword clusters for campaign messaging and unique selling
              points.
            </span>
          </div>
        </div>
